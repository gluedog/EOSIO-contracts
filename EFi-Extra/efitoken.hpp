...
namespace eosio {
    ...
    */
   class [[eosio::contract("efitoken")]] token : public contract {
      public:
         ...
         /**
          * This is the EFiToken Burn action. Anyone can burn their own tokens, reducing the maximum and circulating supply.
          */
         [[eosio::action]]
         void burn(const name& owner_account, const asset& quantity, const string&  memo);

         /* Mint Tokans */
         //[[eosio::action]]
//         void mint(const name& minter, const asset& quantity);
